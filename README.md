...
1: Import required libraries and load the email dataset.

2: Convert email text into numerical features and split the data into training and testing sets.

3: Train the SVM classifier using the training data.

4: Test the model with test data and display whether the email is spam or not spam.
